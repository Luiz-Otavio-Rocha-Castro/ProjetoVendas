...
import com.minhavendas.vendas.security.VendedorDetailService;
...
public class AuthFilterToken extends OncePerRequestFilter{
    ...
    @Autowired
    private VendedorDetailService vendedorDetailService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try{
            ...
            if(jwt != null && jwtUtils.validateJwtToken(jwt)){
                ...
                String username = jwtUtils.getEmailToken(jwt);

                UserDetails userDetails = vendedorDetailService.loadUserByUsername(username);
